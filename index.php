...
<head>
  ...
  <title>"InnoVision Studios"- website for a fictional creative agency</title>
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-xl-11 d-flex align-items-center justify-content-between">
          <h1 class="logo"><a href="index.html">InnoVision Studios</a></h1>
...
<main id="main">
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>InnoVision Studios</strong>. All Rights Reserved @2024
      </div>
      <div class="credits">
        Designed by <a href="https://InnoVision Studios.com/">InnoVision Studios </a>
      </div>
    </div>
  </footer><!-- End Footer -->
